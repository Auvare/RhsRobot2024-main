...
/** Add your docs here. */
public class MidLineSourceClear extends AutonomousRoutine {

    public MidLineSourceClear(FMJRobot robot, double velocity, double acceleration, boolean isRedAlliance) {
        ...
        PathPlannerPath firstPath = PathPlannerPath.fromPathFile("Blue C 2N");
        PathPlannerPath secondPath = PathPlannerPath.fromPathFile("Blue C 3N");
