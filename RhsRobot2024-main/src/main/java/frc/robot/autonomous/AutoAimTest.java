...
/** Add your docs here. */
public class AutoAimTest extends AutonomousRoutine {
    ...
    public AutoAimTest(FMJRobot robot, double velocity, double acceleration,
        ...
        PathPlannerPath firstPath = PathPlannerPath.fromPathFile("Auto Aim Test");
        PathPlannerPath secondPath = PathPlannerPath.fromPathFile("Auto Aim Test 2");
        PathPlannerPath thirdPath = PathPlannerPath.fromPathFile("Auto Aim Test 3");
