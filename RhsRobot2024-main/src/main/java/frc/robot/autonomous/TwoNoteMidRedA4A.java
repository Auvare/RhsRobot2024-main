...
/** Add your docs here. */
public class TwoNoteMidRedA4A extends AutonomousRoutine {

    public TwoNoteMidRedA4A(FMJRobot robot, double velocity, double acceleration, boolean isRedAlliance) {
        ...
        PathPlannerPath fourthPath = PathPlannerPath.fromPathFile("A6A");
