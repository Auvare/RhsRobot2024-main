...
public class ShooterSubsystem extends SubsystemBase {
    ...
    public static final double SHOOT_SPEED = 40; //40 rotations / sec
    public static final double AMP_SPEED = 12;
    public static final double FEED_SPEED = 32;
    ...
    public ShooterSubsystem() {
        ...
        FMJRobot.FMJOrchestra.addInstrument(upperShooter);
        FMJRobot.FMJOrchestra.addInstrument(lowerShooter);
    ...
    public void setFeedSpeed() {
        upperShooter.setControl(velocityDC.withVelocity(FEED_SPEED));
        lowerShooter.setControl(velocityDC.withVelocity(FEED_SPEED));
    }
    ...
    public double getShooterSpeed() {
        return upperShooter.getVelocity().getValueAsDouble();
    }
}
