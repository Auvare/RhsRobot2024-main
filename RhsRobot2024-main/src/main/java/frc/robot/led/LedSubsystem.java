...
public class LedSubsystem extends SubsystemBase {
    ...
    private BooleanSubscriber climberDown;
    ...
    public LedSubsystem() {
        ...
        BooleanTopic climberTopic = fmjTable.getBooleanTopic("climberHeight");
        climberDown = climberTopic.subscribe(true);
    ...
    private void flickerOrangeFlame() {
        int red = 255;
        int green = 65;
        int blue = 0;
        for (int i = 0; i < ledCount; i++) {
