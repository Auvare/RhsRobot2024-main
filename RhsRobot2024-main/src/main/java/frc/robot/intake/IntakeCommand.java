...
public class IntakeCommand extends Command {
    ...
    public IntakeCommand(IntakeSubsystem intake, FeederSubsystem feeder, IWrist wrist, int timeout) {
        isTimeout = timeout;
        
        // Use addRequirements() here to declare subsystem dependencies.
        addRequirements(intake, feeder, (Subsystem)wrist);
    ...
    /** Creates a new IntakeCommand. */
    public IntakeCommand(IntakeSubsystem intake, FeederSubsystem feeder, IWrist wrist) {
