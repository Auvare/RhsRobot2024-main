...
public class Competition extends TimedRobot {
    ...
    // TODO: we need to find out what the real serial numbers are for the bots
    private final String practiceBot =    "030dbe0a";
    private final String competitionBot = "3260aad";
    ...
    public void robotInit() {
        ...
        if (practiceBot.equals(RobotController.getSerialNumber())) {
    ...
    public void disabledInit() {
        StatusCode status = FMJRobot.FMJOrchestra.loadMusic("SmokeOnTheWater.chrp");
